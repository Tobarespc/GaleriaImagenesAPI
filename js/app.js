...
//Cantidad de elementos por pagina, cuarenta por pagina
...
function buscarImagenes(){
    ...
    const key = '29100857-52d0ce3698c2fc50f578df8b4';
...
function mostrarImagenes(imagenes){
    ...
    //LimpiarHMTL, eliminar resultados previos
    while(resultado.firstChild){
        resultado.removeChild(resultado.firstChild);
    }

    //Iterar sobre el arreglod e images y construir el HTML
    ...
    //Generamos el nuevo HTML de paginas
    imprimirPaginador();
}
...
function validarFormulario(e){
    ...
    if(terminoBusqueda === ''){
        mostrarAlerta('Agregar un término de búsquedad');
        return;
    }
